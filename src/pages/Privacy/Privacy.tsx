    ...
    <Container className="mb-5">
      <Row className="justify-content-center mt-4">
        <Col md={10} lg={8} className="mx-auto">
          ...
          <a href="/" className="privacy-home-link">Home</a>
          ...
          <p className="privacy-content">
            At Indiana University (IU), we are committed to protecting the privacy and confidentiality of personal information entrusted to us. By accessing and using IU's services, you acknowledge and consent to the practices described in our global privacy statement here: <a href="https://privacy.iu.edu/privacy/global.html">https://privacy.iu.edu/privacy/global.html</a>.
          </p>
          <p className="privacy-content">
            For additional information outlining how College of Arts + Sciences Earth and Atmospheric Science collects, uses, and safeguards personal information obtained specifically through our website (<a href="https://js2-gateway.ear180013.projects.jetstream-cloud.org/">Zhu Applications</a>), please also review the information below.
          </p>
          <p className="privacy-content">
          ...
          <p className="privacy-content">
            Visitors to other IU websites should review the privacy notices for the sites they visit, as other units at the university may collect and use visitor information in different ways. College of Arts + Sciences Earth and Atmospheric Science is not responsible for the content of other websites or for the privacy practices of websites outside the scope of this notice.
          </p>
          
          <h2 className="privacy-section-title">Changes</h2>
          <p className="privacy-content">
            Because Internet technologies continue to evolve rapidly, College of Arts + Sciences Earth and Atmospheric Science may make appropriate changes to this notice in the future. Any such changes will be consistent with our commitment to respecting visitor privacy, and will be clearly posted in a revised privacy notice.
          </p>
          
          <h2 className="privacy-section-title">Collection and Use</h2>
          <h3 className="privacy-section-subtitle">Passive/Automatic Collection</h3>
          <p className="privacy-content">
            When you view pages on our site, the web server automatically collects certain technical information from your computer and about your connection. This information is outlined in the <a href="https://privacy.iu.edu/privacy/global.html">IU Privacy statement</a>.
          </p>
          <p className="privacy-content">
            In addition to any information outlined in the global statement, our server and/or site collects the following:
          </p>
          ...
          <h3 className="privacy-section-subtitle">Active/Manual/Voluntary Collection</h3>
          <p className="privacy-content">
            We will not attempt to collect any information from you through the use of forms or other types of manual input.
          </p>
          ...
          <h3 className="privacy-section-subtitle">Information Used For Contact</h3>
          <p className="privacy-content">
            If you supply us with your postal/mailing address:
          </p>
          <ul className="privacy-content">
            <li>You will only receive the information for which you provided us your address</li>
          </ul>

          <h3 className="privacy-section-subtitle">Information Sharing</h3>
          <p className="privacy-content">
            Except as described in the <a href="https://privacy.iu.edu/privacy/index.html">IU Privacy statement</a>, we will not share any information with any other entities or organizations for any reason.
          </p>
          <p className="privacy-content">
          ...
          <h3 className="privacy-section-subtitle">Use of Third Party Services</h3>
          <p className="privacy-content">
            Our website does not utilize web analytics services beyond what is noted in the <a href="https://privacy.iu.edu/privacy/index.html">IU Privacy statement</a>.
          </p>

          <h3 className="privacy-section-subtitle">Updating Inaccurate Information</h3>
          <p className="privacy-content">
          ...
          <ul className="privacy-content">
            <li>We have appropriate security measures in place in our physical facilities to protect against the loss, misuse, or alteration of information that we have collected from you at our site.</li>
            <li>Once we receive user information, we will use reasonable safeguards consistent with prevailing industry standards and commensurate with the sensitivity of the data being stored to maintain the security of that information on our systems.</li>
            <li>We will comply with all applicable federal, state, and local laws regarding the privacy and security of user information.</li>
          </ul>

          <h2 className="privacy-section-title">Links to non-university sites</h2>
          <p className="privacy-content">
